        ...
        {watchlist.length === 0 ? (
          <div className="text-center py-20 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-400">
              Start adding coins from the home page to track them here.
            </p>
            <a
              href="/"
              className="mt-6 inline-block px-6 py-3 bg-primary-600 hover:bg-primary-700 text-white rounded-lg transition-colors"
            >
              Browse Coins
            </a>
          </div>
